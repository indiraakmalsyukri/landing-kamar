    ...
    <div class="surface-0 flex justify-content-center">
        <div id="home" class="landing-wrapper overflow-hidden">
            <div class="py-4 px-4 mx-0 md:mx-6 lg:mx-8 lg:px-8 flex align-items-center justify-content-between relative lg:static mb-3">
                <a class="flex align-items-center" href="#"> <img :src="logoUrl" alt="Sakai Logo" height="50" class="mr-0 lg:mr-2" /><span class="text-900 font-medium text-2xl line-height-3 mr-8">company</span> </a>
            ...
            >
                ...
                <div class="flex justify-content-center md:justify-content-end">
                    <img src="/demo/images/landing/female-dormitory-roommates-live-together-260nw-1907953441.webp" alt="Hero Image" class="w-9 md:w-auto" />
                </div>
            </div>
            ...
            <div id="features" class="py-4 px-4 lg:px-8 mt-5 mx-0 lg:mx-8">
                <div class="grid justify-content-center">
                    <div class="col-12 text-center mt-8 mb-4">
                        <h2 class="text-900 font-normal mb-2">service</h2>
                    ...
                    <div class="col-12 md:col-12 lg:col-4 p-0 lg:pr-5 lg:pb-5 mt-4 lg:mt-0">
                        ...
                        >
                            <div class="p-3 surface-card h-full" style="border-radius: 8px">
                                ...
                                <h5 class="mb-2 text-900">Easy to book</h5>
                    ...
                    <div class="col-12 md:col-12 lg:col-4 p-0 lg:pr-5 lg:pb-5 mt-4 lg:mt-0">
                        ...
                        >
                            <div class="p-3 surface-card h-full" style="border-radius: 8px">
                                ...
                                <h5 class="mb-2 text-900">always clean</h5>
                    ...
                    <div class="col-12 md:col-12 lg:col-4 p-0 lg:pb-5 mt-4 lg:mt-0">
                        ...
                        >
                            <div class="p-3 surface-card h-full" style="border-radius: 8px">
                                ...
                                <h5 class="mb-2 text-900">lorem ipsum</h5>
                    ...
                    >
                        <div class="flex flex-column justify-content-center align-items-center text-center px-3 py-3 md:py-0">
                            <h3 class="text-gray-900 mb-2">testimonial</h3>
                            <span class="text-gray-600 text-2xl">joko</span>
            ...
            <div id="highlights" class="py-4 px-4 lg:px-8 mx-0 my-6 lg:mx-8">
                <div class="text-center">
                    <h2 class="text-900 font-normal mb-2">facillity</h2>
                ...
                <div class="grid mt-8 pb-2 md:pb-8">
                    <div class="flex justify-content-center col-12 lg:col-6 bg-purple-100 p-0 flex-order-1 lg:flex-order-0" style="border-radius: 8px">
                        <img src="/demo/images/landing/images.jpg" class="w-11" />
                    </div>
                ...
                <div class="grid my-8 pt-2 md:pt-8">
                    ...
                    <div class="flex justify-content-end flex-order-1 sm:flex-order-2 col-12 lg:col-6 bg-yellow-100 p-0" style="border-radius: 8px">
                        <img src="/demo/images/landing/images.jpg" class="w-11" alt="mockup" />
                    </div>
                </div>
            </div>
                ...
                <div class="grid justify-content-between mt-8 md:mt-0">
                    <div class="col-12 lg:col-4 p-0 md:p-3">
                        <div class="p-3 flex flex-column border-200 pricing-card cursor-pointer border-2 hover:border-primary transition-duration-300 transition-all" style="border-radius: 10px">
                            <h3 class="text-900 text-center my-5">room 1</h3>
                            <img src="/demo/images/landing/room.jpg" class="w-10 h-10 mx-auto" alt="free" />
                            <div class="my-5 text-center">
                                <span class="text-5xl font-bold mr-2 text-900">Rp.1000</span>
                                <span class="text-600">per day</span>
                            </div>
                            <Divider class="w-full bg-surface-200"></Divider>
                            <ul class="my-5 list-none p-0 flex text-900 flex-column">
                                <li class="py-2">
                                    <i class="pi pi-fw pi-check text-xl text-cyan-500 mr-2"></i>
                                    <span class="text-xl line-height-3">2 bed</span>
                                </li>
                                <li class="py-2">
                                    <i class="pi pi-fw pi-check text-xl text-cyan-500 mr-2"></i>
                                    <span class="text-xl line-height-3">room size</span>
                                </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="col-12 lg:col-4 p-0 md:p-3 mt-4 md:mt-0">
                        <div class="p-3 flex flex-column border-200 pricing-card cursor-pointer border-2 hover:border-primary transition-duration-300 transition-all" style="border-radius: 10px">
                            <h3 class="text-900 text-center my-5">room 2</h3>
                            <img src="/demo/images/landing/room.jpg" class="w-10 h-10 mx-auto" alt="startup" />
                            <div class="my-5 text-center">
                                <span class="text-5xl font-bold mr-2 text-900">Rp.1000</span>
                                <span class="text-600">per day</span>
                            </div>
                    ...
                    <div class="col-12 lg:col-4 p-0 md:p-3 mt-4 md:mt-0">
                        <div class="p-3 flex flex-column border-200 pricing-card cursor-pointer border-2 hover:border-primary transition-duration-300 transition-all" style="border-radius: 10px">
                            <h3 class="text-900 text-center my-5">room 3</h3>
                            <img src="/demo/images/landing/room.jpg" class="w-10 h-10 mx-auto" alt="enterprise" />
                            <div class="my-5 text-center">
                                <span class="text-5xl font-bold mr-2 text-900">Rp.1000</span>
                                <span class="text-600">per day</span>
                            </div>
            ...
            <div id="pricing" class="py-4 px-4 lg:px-8 my-2 md:my-4">
                <div class="text-center">
                    <h2 class="text-900 font-normal mb-2">team</h2>
                    <span class="text-600 text-2xl">Amet consectetur adipiscing elit...</span>
                </div>
                ...
                <div class="grid justify-content-between mt-8 md:mt-0">
                    <div class="col-12 lg:col-4 p-0 md:p-3">
                        <div class="p-3 flex flex-column border-200 pricing-card cursor-pointer border-2 hover:border-primary transition-duration-300 transition-all" style="border-radius: 10px">
                            ...
                            <img src="/demo/images/landing/user.png" class="w-10 h-10 mx-auto" alt="free" />
                            <div class="my-5 text-center">
                                <span class="text-600">name</span>
                            </div>
                            <div class="my-5 text-center">
                                <span class="text-600">job</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-12 lg:col-4 p-0 md:p-3 mt-4 md:mt-0">
                        <div class="p-3 flex flex-column border-200 pricing-card cursor-pointer border-2 hover:border-primary transition-duration-300 transition-all" style="border-radius: 10px">
                            ...
                            <img src="/demo/images/landing/user.png" class="w-10 h-10 mx-auto" alt="startup" />
                            <div class="my-5 text-center">                              
                                <span class="text-600">name</span>                          
                            </div>
                            <div class="my-5 text-center">
                    ...
                    <div class="col-12 lg:col-4 p-0 md:p-3 mt-4 md:mt-0">
                        <div class="p-3 flex flex-column border-200 pricing-card cursor-pointer border-2 hover:border-primary transition-duration-300 transition-all" style="border-radius: 10px">
                            <img src="/demo/images/landing/user.png" class="w-10 h-10 mx-auto" alt="enterprise" />
                            <div class="my-5 text-center">
                                <span class="text-600">name</span>                               
                            </div>
                            <div class="my-5 text-center">
                ...
                <div class="grid justify-content-between">
                    <div class="col-12 md:col-2" style="margin-top: -1.5rem">
                        <a @click="smoothScroll('#home')" class="flex flex-wrap align-items-center justify-content-center md:justify-content-start md:mb-0 mb-3 cursor-pointer">
                            ...
                            <h4 class="font-medium text-3xl text-900">company</h4>
                        </a>
                    </div>
